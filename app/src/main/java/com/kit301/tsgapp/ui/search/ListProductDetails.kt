...
class ListProductDetails : DrawerBaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var favouriteProductID = -1
        var favouriteProductObject = Product()
        //Retrieve the product extra information from previous page
        if(filterOn){
            favouriteProductID = intent.getIntExtra(FilterProductIndex, -1)
            favouriteProductObject = filtered[favouriteProductID]
        }else{
            favouriteProductID = intent.getIntExtra(ListProductIndex, -1)
            favouriteProductObject = ProductItems[favouriteProductID]
        }
